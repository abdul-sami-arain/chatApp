...
class Landing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance.collection('chats').orderBy('timestamp', descending: false).snapshots();
          ...
          Container(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                GestureDetector(
                  onTap: () {
                    CollectionReference chatRoom = FirebaseFirestore.instance.collection('chats');
                    chatRoom.add({
